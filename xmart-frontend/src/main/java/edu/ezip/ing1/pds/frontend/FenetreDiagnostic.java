 ...
 * private JButton boutonAjouter, boutonAfficher, boutonModifier,
 * boutonSupprimer, boutonDiagnostiquer;
 ...
 * 
 * if (ServiceDiagnostic.modifierSymptome(idPatient, symptomeSelectionne,
 * nouveauNom)) {
 * afficherSymptomes();
